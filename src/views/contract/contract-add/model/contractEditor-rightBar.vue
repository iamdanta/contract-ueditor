          ...
          <transition name="spread-in" mode="out-in">
            ...
            <div key="inputDrawer" v-if="updateDrawerType === 'inputDrawer'">
              ...
              <el-form-item class="randomValueInput" label="字段存值绑定">
                <dictionary-cascader type="合同模板存值" v-model="drawerFormData.model" placeholder="不填为不存库" filterable  clearable :isShowAll="true"></dictionary-cascader>
              </el-form-item>
              <el-form-item class="randomValueInput" label="字段取值绑定">
                <dictionary-cascader type="合同模板取值" v-model="drawerFormData.readModel" placeholder="不填为不读取赋值" filterable clearable :isShowAll="true"></dictionary-cascader>
              </el-form-item>
              ...
              <div class="drawer-footer">
                ...
                <el-button type="primary" @click="drawerVisible(false, 'drawerFormData')">保存修改</el-button>
              </div>
            </div>
            <!--select控件-->
            <div key="selectDrawer" v-if="updateDrawerType === 'selectDrawer'">
              ...
              <el-form-item v-if="!drawerFormData.isDicSelect" label="新增可选项" class="selectOptionAdd">
                ...
                <el-button type="primary" @click="addNewSelectOption(drawerFormData.selectOption)"><i
...
<script>
  ...
  export default {
    ...
    methods: {
      //从外部调的方法打开
      openUpdateDrawer(visible, drawerType, drawerInitData) {
